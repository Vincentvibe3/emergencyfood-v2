    ...
    fun getButtonsRow(currentPage:Int, lastPage:Int):ActionRow{
        return if (currentPage==lastPage&&lastPage!=1){
            ActionRow.of(
                ...
                io.github.vincentvibe3.emergencyfood.buttons.music.queue.QueueEnd.getDisabled()
            )
            ...
            ActionRow.of(
                ...
                io.github.vincentvibe3.emergencyfood.buttons.music.queue.QueueEnd.getEnabled()
            )
        } else {
            ActionRow.of(
                QueueStart.getEnabled(),
